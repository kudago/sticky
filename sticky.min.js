...
"px"},s:function(a,b){a.style.cssText=this.j;a.style.position="fixed";a.style.top=this.offset.top+this.options.offset+"px";a.classList.add(this.options.stickyClass);l(a,b||this.b)},recalc:function(){var a=this.e?this.a:this.b;this.b.innerHTML=this.a.innerHTML;this.l=k(this.parent);this.height=this.a.offsetHeight;var b=getComputedStyle(a);b.marginLeft.slice(0,-2);b.marginRight.slice(0,-2);this.f=~~b.marginTop.slice(0,-2);this.i=~~b.marginBottom.slice(0,-2);this.restrictWithin instanceof Element?(b=
k(this.restrictWithin),this.c.top=Math.max(b.top,k(a).top),this.c.bottom=this.restrictWithin.offsetHeight+b.top):this.restrictWithin instanceof Object?this.c=this.restrictWithin:(this.c.top=k(a).top,this.c.bottom=this.l.height+this.l.top);this.offset.bottom=0;this.offset.top=0;if(this.stack.length)for(var c=this.stack.length;c--;){if(b=f.stack[this.stack[c]][this.g[c]-1]){var d=b.e?b.a:b.b;this.offset.top=b.offset.top+b.options.offset;var e;if(!(e=!this.options.collapse)){e=a.offsetLeft;var g=a.offsetLeft+
a.offsetWidth,h=d.offsetLeft,d=d.offsetWidth+d.offsetLeft;e=g<h&&e<h||g>d&&e>d?!1:!0}if(e)for(this.offset.top+=b.height+Math.max(b.f,b.i),d=f.stack[this.stack[c]][this.g[c]],e=this.g[c]-1;b=f.stack[this.stack[c]][e];e--)b.offset.bottom=Math.max(b.offset.bottom,d.offset.bottom+d.height+d.f+d.i),d=b}}else if(b=f.p[this.g[0]-1])b.c.bottom=this.c.top-this.f;clearTimeout(this.v);this.v=setTimeout(this.m,0)},m:function(){this.e?this.a.style.cssText=this.j:this.d?this.r(this.a):this.s(this.a);this.h()}};
h?h.fn.sticky=function(a){return this.each(function(b,c){var d=h(c),e=new f(d[0],a);d.data("sticky",e)})}:window.Sticky=f})(window.jQuery||window.Zepto);
