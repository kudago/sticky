...
else this.k[0]=e.D.length,e.D.push(this);this.b=this.a.cloneNode();this.b.classList.add(this.options.stubClass);this.b.style.visibility="hidden";this.b.style.display="none";this.b.removeAttribute("hidden");this.q=this.a.style.cssText;this.C=getComputedStyle(this.a).display;"static"==getComputedStyle(this.parent).position&&(this.parent.style.position="relative");this.m=this.m.bind(this);this.recalc=this.recalc.bind(this);this.w=this.w.bind(this);this.disable=this.disable.bind(this);this.enable=this.enable.bind(this);
this.B=this.B.bind(this);this.A=this.A.bind(this);this.F=this.F.bind(this);this.l=this.l.bind(this);this.G=this.G.bind(this);this.t=this.t.bind(this);this.p=this.p.bind(this);this.r=this.r.bind(this);this.u=this.u.bind(this);g(document,"sticky:recalc",this.recalc);g(this.a,"sticky:recalc",this.recalc);g(this.a,"DOMNodeRemoved",this.disable);g(this.a,"DOMNodeInserted",this.enable);g(this.a,"sticky:disable",this.disable);g(this.a,"sticky:enable",this.enable);"none"===this.C?(this.C="block",this.disable()):
this.enable()}var p=["object","iframe","embed","img"],n=["left","top","right","bottom"],m=["padding-","border-"];e.list=[];e.D=[];e.stack={};e.s={};e.prototype={options:{offset:0,restrictWithin:null,vAlign:"top",stubClass:"sticky-stub",stickyClass:"is-stuck",bottomClass:"is-bottom",topClass:"is-top",stack:null,collapse:!0,P:20},disable:function(){this.b.parentNode&&this.parent.removeChild(this.b);this.Q();document.dispatchEvent(new CustomEvent("sticky:recalc"))},enable:function(){this.b.parentNode||
this.parent.insertBefore(this.b,this.a);this.B();this.recalc();document.dispatchEvent(new CustomEvent("sticky:recalc"))},B:function(){document.addEventListener("scroll",this.m);window.addEventListener("resize",this.recalc);this.a.addEventListener("mouseover",this.r);this.a.addEventListener("mouseout",this.u)},Q:function(){document.removeEventListener("scroll",this.m);window.removeEventListener("resize",this.recalc);this.a.removeEventListener("mouseover",this.r);this.a.removeEventListener("mouseout",
...
d.height+d.f+d.j),d=b}e.s[this.stack[c]]=this.offset.top+this.height+this.f+this.j}else if(b=e.D[this.k[0]-1])b.g.bottom=this.g.top-this.f;clearTimeout(this.O);this.O=setTimeout(this.A,0)},A:function(){this.c?this.a.style.cssText=this.q:this.d?this.I():this.K();this.m()}};window.v?(k.fn.sticky=function(a){return this.each(function(b,c){var d=k(c),f=new e(d[0],a);d.data("sticky",f)})},e.v=window.v):window.Sticky=e})(window.jQuery||window.Zepto);
